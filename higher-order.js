...
let myStrongest = monstersInYourPocket.filter(monster => monster.CP > 200);// Your code here
...
let ordersTotal = orders.map(order => order.price * (1 + order.tax) );// Your code here
...
let bobsTotal = purchases.reduce((total,curr)=>{ 
    if(curr.owner === "Bob"){
